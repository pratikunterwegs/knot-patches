...
## load functions
source("\\CODE\\function-retrieve_location_data.r")
source("\\CODE\\function-clean_location_data.r")
...
#####################	
	...
	ldf_raw <- lapply(tags, get_data, from=from, to=to, tag_prefix="31001000")
