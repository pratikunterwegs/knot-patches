...
mod.coherence.consistency = glmmTMB(coherence_emp ~ cn1 + pos_focal + pos_nonfocal + hour + dist_sum + (1|focal) + (1|ht), data = cij, family = binomial, ziformula = ~coherence_emp)
```
