...
names = names(k1.lines); bird = substr(names(k1.lines), 1,3)
...
data = data_frame(index = 1:length(k1.lines),names, bird)# %>% left_join(pskf_data_ids[[1]], by = c("names2" = "id.seg"))
...
#'export
library(rgdal)
writeOGR(k1.lines, dsn = "knots_data/knots_spatials/", layer = "k1_5pt_median", driver = "ESRI Shapefile", overwrite_layer = T)
```
