...
ToPlot=0#can be 0 (no plot) or 1 (create plots)- note this will slow the proccess a lot!!
...
DriftHRCenters=1#1 or 0 for a drift of the center in space along the simulation (i.e. the changing environment scenarios), 0 is no drift.
...
DriftStrength=c(0,1)#if DriftHRCenters==1 this defines drift in m per day for X and Y values in the simulation 
...
StpSize_ind=6 #Mean step lengths of individuals;
