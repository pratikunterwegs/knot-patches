...
NB: This section not currently working.

We attempt to make an animation of the tidal cycle around Griend.
...
```{r include_gif, eval=FALSE, fig.cap="Waterlevel at West Terschelling and effect on coverage of mudflats around Griend."}
