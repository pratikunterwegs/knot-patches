...
ggsave(fig_waterlevel_area,
  filename = "figs/fig_waterlevel_area.png",
...
## ----include_gif, eval=FALSE, fig.cap="Waterlevel at West Terschelling and effect on coverage of mudflats around Griend."----
